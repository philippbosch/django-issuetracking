...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Issue.project'
        db.add_column('issuetracking_issue', 'project', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['issuetracking.Project']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Issue.project'
        db.delete_column('issuetracking_issue', 'project_id')
    ...
    models = {
        ...
        'issuetracking.issue': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['issuetracking.Project']"}),
